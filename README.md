...
<body>
    ...
    <ol type="I">
        <li>jogging every MWF sched</li><li>Go to school and attend classes</li><li>Do homework and assignments</li><li>train my skills like coding and do basketball training </li><li>Reading physchology books and also dark physchology</li>
    </ol>
    <hr>
    <h2>5. My Countdown to Success</h2>
    <ol reversed>
        <li>Achieve My Dream Career</li><li>Finish College</li><li>be a financially rich tito </li>
    </ol>
